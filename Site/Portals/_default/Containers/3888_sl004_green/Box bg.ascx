...
<table width="100%" cellspacing="0" cellpadding="0" align="center" border="0" style="border-left: #B7B7B7 1px solid; border-right: #B7B7B7 1px solid; border-top: #B7B7B7 1px solid; border-bottom: #B7B7B7 1px solid;">
	...
	<tr valign="top">
		<td bgcolor="#dcdcdc" style="border-left: #ffffff 1px solid; border-right: #ffffff 1px solid; border-bottom: #ffffff 1px solid;">
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="border-top: #B7B7B7 1px solid;">
			<tr valign="top">
