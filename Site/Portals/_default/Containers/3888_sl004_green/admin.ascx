...
<table width="100%" cellspacing="0" cellpadding="0" align="center" border="0" style="border-left: #bebebe 1px solid; border-right: #bebebe 1px solid; border-top: #bebebe 1px solid; border-bottom: #bebebe 1px solid;">
	<tr>
		<td height="30" bgcolor="#f2f2f2" style="border-bottom: #bebebe 1px solid;">
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td valign="middle" nowrap><dnn:SOLPARTACTIONS runat="server" id="dnnSOLPARTACTIONS" /></td>
				<td valign="middle" style="padding-left: 5px; padding-right: 5px;" nowrap><dnn:ICON runat="server" id="dnnICON" /></td>
				<td width="100%" valign="middle" style="padding-left: 5px; padding-right: 5px;" nowrap><dnn:TITLE runat="server" id="dnnTITLE" CssClass="Contitle_Admin" /></td>
