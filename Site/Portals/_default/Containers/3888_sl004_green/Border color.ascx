...
<table width="100%" cellspacing="0" cellpadding="0" align="center" style="border-left: 1px #36750B solid; border-right: 1px #36750B solid; border-top: 1px #36750B solid; border-bottom: 1px #36750B solid;">
	<tr>
		<td height="23">
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="100%" valign="middle" style="padding-left: 5px; padding-right: 5px;" nowrap><dnn:TITLE runat="server" id="dnnTITLE" CssClass="Contitle_Color_UC" /></td>
