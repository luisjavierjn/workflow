...
<table width="100%" cellspacing="0" cellpadding="0" align="center" border="0">
	<tr>
		...
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="100%" valign="middle" style="padding-left: 5px; padding-right: 5px;" nowrap><dnn:TITLE runat="server" id="dnnTITLE" CssClass="Contitle_Black_11px" /></td>
	...
	<tr valign="top">
		<td bgcolor="#f2f2f2" style="border-bottom: #bebebe 1px solid;">
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			<tr valign="top">
