...
<table border="0" cellspacing="0" cellpadding="0" width="780" height="100%">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" align="center">
			<tr>
				<td align="left" valign="top" nowrap><img src="<%= SkinPath %>media/bread_img.gif"><span class="Breadcrumb"><dnn:BREADCRUMB runat="server" id="dnnBREADCRUMB" Separator="&lt;img src=&quot;media/breadcrumb.gif&quot;&gt;" CssClass="Breadcrumb_Link" RootLevel="0" />&nbsp;</td>
				<td align="right" style="padding-right: 0px;"><span id="LanguageComboBox"><dnn:LANGUAGE runat="server" id="dnnLANGUAGE" /></span></td>
			</tr>
		</table>
		</td>
	</tr>
	<tr>
		<td height="100%" valign="top" style="padding-left: 0px; padding-top: 0px;">
		<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" align="center">
			<tr>
				<td id="TopPane" class="toppanep" runat="server" valign="top"></td>
			</tr>
			<tr>
				<td>
				<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" align="center">
					<tr>
						<td id="LeftPane" class="leftpanep" runat="server" valign="top"></td>
			...
			<tr>
				<td id="BottomPane" class="bottompanep" runat="server" valign="top"></td>
			</tr>
			<tr>
				<td id="BottomPane2" class="bottompanep2" runat="server" valign="bottom"></td>
			</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		<td height="25" align="center" valign="middle" bgcolor="#f2f2f2" style="padding-top: 3px;" nowrap>
	...
	<tr>
		<td height="21" align="center" valign="top" bgcolor="#DFDFDF" nowrap>&nbsp;
