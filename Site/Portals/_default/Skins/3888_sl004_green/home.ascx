...
<table border="0" cellspacing="0" cellpadding="0" width="780" height="100%">
	...
	<tr>
		<td height="100%" valign="top" style="padding-left: 0px; padding-top: 2px;">
		<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" align="center">
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" align="center">
					...
					<tr>
						<td id="TopPane" class="toppane" runat="server" valign="top"></td>
					</tr>
					<tr>
						<td>
						<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" align="center">
					...
					<tr>
						<td id="BottomPane" class="bottompane" runat="server" valign="top"></td>
					</tr>
					<tr>
						<td id="BottomPane2" class="bottompane2" runat="server" valign="bottom"></td>
					</tr>
				</table>				
				</td>
			</tr>
