	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" align="center">
			<tr>
				...
				<td align="right" style="padding-right: 5px;"><span id="LanguageComboBox"><dnn:LANGUAGE runat="server" id="dnnLANGUAGE" /></span></td>
			</tr>
		</table>
		</td>
	</tr>
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" align="center">
			...
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%" align="center">
					<tr>
						<td id="LeftPane" class="leftpanef" runat="server" valign="top"></td>
