...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/BarFrameRTL.gif"></td>
		<td id="Td_Title_b014v20" background="<%= SkinPath %>media/BarFrameRTC.gif" style="background-repeat: repeat-x; background-position: center bottom;">
		...
		<td><img src="<%= SkinPath %>media/BarFrameRTR.gif"></td>
	</tr>
	<tr>
