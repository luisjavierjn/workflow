...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/FrameBoxRGrayWTL.gif"></td>
		<td background="<%= SkinPath %>media/FrameBoxRGrayWTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/FrameBoxRGrayWTR.gif"></td>
	</tr>
	<tr>
			...
			<tr>
				...
				<table id="Table_Title_b014v20" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<dnn:TITLE runat="server" id="dnnTITLE" cssclass="dnnTitleGray12px_b014v20" />
						</td>
