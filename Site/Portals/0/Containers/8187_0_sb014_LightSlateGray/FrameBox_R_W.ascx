...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/FrameBoxRWTL.gif"></td>
		<td background="<%= SkinPath %>media/FrameBoxRWTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/FrameBoxRWTR.gif"></td>
	</tr>
	<tr>
		<td background="<%= SkinPath %>media/FrameBoxRWML.gif" style="background-repeat: repeat-y; background-position: right center;"></td>
			...
			<tr>
				...
				<table id="Table_Title_b014v20" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<dnn:TITLE runat="server" id="dnnTITLE" cssclass="dnnTitleColor12px_b014v20" />
						</td>
		...
		<td background="<%= SkinPath %>media/FrameBoxRWMR.gif" style="background-repeat: repeat-y; background-position: left center;"></td>
	</tr>
	<tr>
		<td><img src="<%= SkinPath %>media/FrameBoxRWBL.gif"></td>
		<td background="<%= SkinPath %>media/FrameBoxRWBC.gif" style="background-repeat: repeat-x; background-position: center top;"></td>
		<td><img src="<%= SkinPath %>media/FrameBoxRWBR.gif"></td>
	</tr>
</table>
