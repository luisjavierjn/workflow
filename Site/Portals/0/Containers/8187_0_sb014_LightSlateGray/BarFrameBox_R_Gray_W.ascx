...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/BarFrameRGrayTL.gif"></td>
		<td id="Td_Title_b014v20" background="<%= SkinPath %>media/BarFrameRGrayTC.gif" style="background-repeat: repeat-x; background-position: center bottom;">
		<table id="Table_Title_b014v20" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<dnn:TITLE runat="server" id="dnnTITLE" cssclass="dnnTitleColorDark11px_b014v20" />
				</td>
		...
		<td><img src="<%= SkinPath %>media/BarFrameRGrayTR.gif"></td>
	</tr>
	<tr>
		<td background="<%= SkinPath %>media/FrameBoxRGrayWML.gif" style="background-repeat: repeat-y; background-position: right center;"></td>
		...
		<td background="<%= SkinPath %>media/FrameBoxRGrayWMR.gif" style="background-repeat: repeat-y; background-position: left center;"></td>
	</tr>
	<tr>
		<td><img src="<%= SkinPath %>media/FrameBoxRGrayWBL.gif"></td>
		<td background="<%= SkinPath %>media/FrameBoxRGrayWBC.gif" style="background-repeat: repeat-x; background-position: center top;"></td>
		<td><img src="<%= SkinPath %>media/FrameBoxRGrayWBR.gif"></td>
	</tr>
</table>
