...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		...
		<table id="Table_Title_b014v20" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><img src="<%= SkinPath %>media/BarRDarkL.gif"></td>
				<td valign="middle" bgcolor="#5E656B" nowrap>
				<dnn:SOLPARTACTIONS runat="server" id="dnnSOLPARTACTIONS" />
				</td>
				<td valign="middle" bgcolor="#5E656B" nowrap>
				<dnn:ICON runat="server" id="dnnICON" /></td>
				<td width="100%" valign="middle" bgcolor="#5E656B" style="padding: 0px 5px 0px 0px;" nowrap>
				<dnn:TITLE runat="server" id="dnnTITLE" cssclass="dnnTitleWhite11px_b014v20" />
				</td>
				<td valign="top" bgcolor="#5E656B" style="padding: 0px 5px 0px 5px;" nowrap>
				<dnn:VISIBILITY runat="server" id="dnnVISIBILITY" /></td>
				<td><img src="<%= SkinPath %>media/BarRDarkR.gif"></td>
			</tr>
		</table>
		</td>
	</tr>
