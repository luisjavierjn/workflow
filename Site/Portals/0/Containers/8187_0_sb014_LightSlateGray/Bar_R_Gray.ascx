...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		...
		<table id="Table_Title_b014v20" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><img src="<%= SkinPath %>media/BarRGrayL.gif"></td>
				<td valign="middle" bgcolor="#CCCCCC" nowrap>
				<dnn:SOLPARTACTIONS runat="server" id="dnnSOLPARTACTIONS" />
				</td>
				<td valign="middle" bgcolor="#CCCCCC" nowrap>
				<dnn:ICON runat="server" id="dnnICON" /></td>
				<td width="100%" valign="middle" bgcolor="#CCCCCC" style="padding: 0px 5px 0px 0px;" nowrap>
				<dnn:TITLE runat="server" id="dnnTITLE" cssclass="dnnTitleColorDark11px_b014v20" />
				</td>
				<td valign="top" bgcolor="#CCCCCC" style="padding: 0px 5px 0px 5px;" nowrap>
				<dnn:VISIBILITY runat="server" id="dnnVISIBILITY" /></td>
				<td><img src="<%= SkinPath %>media/BarRGrayR.gif"></td>
			</tr>
		</table>
		</td>
	</tr>
