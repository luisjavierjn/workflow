...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/BevelRDarkTL.gif"></td>
		<td background="<%= SkinPath %>media/BevelRDarkTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/BevelRDarkTR.gif"></td>
	</tr>
	<tr>
		<td background="<%= SkinPath %>media/BevelRDarkML.gif" style="background-repeat: repeat-y; background-position: right center;"></td>
		<td width="100%" bgcolor="#E2E3E4">
		...
		<td background="<%= SkinPath %>media/BevelRDarkMR.gif" style="background-repeat: repeat-y; background-position: left center;"></td>
	</tr>
	<tr>
		<td><img src="<%= SkinPath %>media/BevelRDarkBL.gif"></td>
		<td background="<%= SkinPath %>media/BevelRDarkBC.gif" style="background-repeat: repeat-x; background-position: center top;"></td>
		<td><img src="<%= SkinPath %>media/BevelRDarkBR.gif"></td>
	</tr>
</table>
