...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/FrameRLightTL.gif"></td>
		<td background="<%= SkinPath %>media/FrameRLightTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/FrameRLightTR.gif"></td>
	</tr>
	<tr>
		<td background="<%= SkinPath %>media/FrameRLightML.gif" style="background-repeat: repeat-y; background-position: right center;"></td>
		<td width="100%">
		...
		<td background="<%= SkinPath %>media/FrameRLightMR.gif" style="background-repeat: repeat-y; background-position: left center;"></td>
	</tr>
	<tr>
		<td><img src="<%= SkinPath %>media/FrameRLightBL.gif"></td>
		<td background="<%= SkinPath %>media/FrameRLightBC.gif" style="background-repeat: repeat-x; background-position: center top;"></td>
		<td><img src="<%= SkinPath %>media/FrameRLightBR.gif"></td>
	</tr>
</table>
