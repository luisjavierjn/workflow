...
<table cellspacing="0" cellpadding="0" width="100%" align="center">
	<tr>
		<td id="Td_Title_b014v20" class="Border_Gray_b014v20" background="<%= SkinPath %>media/BarImg1.gif" style="background-repeat: repeat-x; background-position: center bottom;">
