...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/FrameBoxRLightWTL.gif"></td>
		<td background="<%= SkinPath %>media/FrameBoxRLightWTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/FrameBoxRLightWTR.gif"></td>
	</tr>
	<tr>
