...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/FrameRTL.gif"></td>
		<td background="<%= SkinPath %>media/FrameRTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/FrameRTR.gif"></td>
	</tr>
	<tr>
		<td background="<%= SkinPath %>media/FrameRML.gif" style="background-repeat: repeat-y; background-position: right center;"></td>
		<td width="100%">
		...
		<td background="<%= SkinPath %>media/FrameRMR.gif" style="background-repeat: repeat-y; background-position: left center;"></td>
	</tr>
	<tr>
		<td><img src="<%= SkinPath %>media/FrameRBL.gif"></td>
		<td background="<%= SkinPath %>media/FrameRBC.gif" style="background-repeat: repeat-x; background-position: center top;"></td>
		<td><img src="<%= SkinPath %>media/FrameRBR.gif"></td>
	</tr>
</table>
