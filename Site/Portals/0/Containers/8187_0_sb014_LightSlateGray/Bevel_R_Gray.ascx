...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/BevelRGrayTL.gif"></td>
		<td background="<%= SkinPath %>media/BevelRGrayTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/BevelRGrayTR.gif"></td>
	</tr>
	<tr>
		<td background="<%= SkinPath %>media/BevelRGrayML.gif" style="background-repeat: repeat-y; background-position: right center;"></td>
		...
		<td background="<%= SkinPath %>media/BevelRGrayMR.gif" style="background-repeat: repeat-y; background-position: left center;"></td>
	</tr>
	<tr>
		<td><img src="<%= SkinPath %>media/BevelRGrayBL.gif"></td>
		<td background="<%= SkinPath %>media/BevelRGrayBC.gif" style="background-repeat: repeat-x; background-position: center top;"></td>
		<td><img src="<%= SkinPath %>media/BevelRGrayBR.gif"></td>
	</tr>
</table>
