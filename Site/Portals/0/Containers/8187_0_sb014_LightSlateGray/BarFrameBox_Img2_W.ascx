...
<table class="Border_Dark_b014v20" cellspacing="0" cellpadding="0" width="100%" align="center" bgcolor="#FFFFFF">
	<tr>
		<td id="Td_Title_b014v20" background="<%= SkinPath %>media/BarImg2.gif" style="background-repeat: repeat-x; background-position: center bottom;">
		<table id="Table_Title_b014v20" class="LineBot_Dark_b014v20" border="0" cellpadding="0" cellspacing="0">
			<tr>
