...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/BevelRTL.gif"></td>
		<td background="<%= SkinPath %>media/BevelRTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/BevelRTR.gif"></td>
	</tr>
	<tr>
		<td background="<%= SkinPath %>media/BevelRML.gif" style="background-repeat: repeat-y; background-position: right center;"></td>
		<td width="100%" bgcolor="#E8EAEC">
		...
		<td background="<%= SkinPath %>media/BevelRMR.gif" style="background-repeat: repeat-y; background-position: left center;"></td>
	</tr>
	<tr>
		<td><img src="<%= SkinPath %>media/BevelRBL.gif"></td>
		<td background="<%= SkinPath %>media/BevelRBC.gif" style="background-repeat: repeat-x; background-position: center top;"></td>
		<td><img src="<%= SkinPath %>media/BevelRBR.gif"></td>
	</tr>
</table>
