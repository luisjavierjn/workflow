...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/FrameRGrayTL.gif"></td>
		<td background="<%= SkinPath %>media/FrameRGrayTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/FrameRGrayTR.gif"></td>
	</tr>
	<tr>
