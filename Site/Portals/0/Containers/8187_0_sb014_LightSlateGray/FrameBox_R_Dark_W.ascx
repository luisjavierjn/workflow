...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/FrameBoxRDarkWTL.gif"></td>
		<td background="<%= SkinPath %>media/FrameBoxRDarkWTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/FrameBoxRDarkWTR.gif"></td>
	</tr>
	<tr>
