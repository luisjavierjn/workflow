...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/BevelRLightTL.gif"></td>
		<td background="<%= SkinPath %>media/BevelRLightTC.gif" style="background-repeat: repeat-x; background-position: center bottom;"></td>
		<td><img src="<%= SkinPath %>media/BevelRLightTR.gif"></td>
	</tr>
	<tr>
		<td background="<%= SkinPath %>media/BevelRLightML.gif" style="background-repeat: repeat-y; background-position: right center;"></td>
		<td width="100%" bgcolor="#F2F4F6">
			...
			<tr>
				...
				<table id="Table_Title_b014v20" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<dnn:TITLE runat="server" id="dnnTITLE" cssclass="dnnTitleColorLight12px_b014v20" />
						</td>
		...
		<td background="<%= SkinPath %>media/BevelRLightMR.gif" style="background-repeat: repeat-y; background-position: left center;"></td>
	</tr>
	<tr>
		<td><img src="<%= SkinPath %>media/BevelRLightBL.gif"></td>
		<td background="<%= SkinPath %>media/BevelRLightBC.gif" style="background-repeat: repeat-x; background-position: center top;"></td>
		<td><img src="<%= SkinPath %>media/BevelRLightBR.gif"></td>
	</tr>
</table>
