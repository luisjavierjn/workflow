...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	...
	<tr>
		<td background="<%= SkinPath %>media/FrameRGrayML.gif" style="background-repeat: repeat-y; background-position: right center;"></td>
		<td width="100%">
		...
		<td background="<%= SkinPath %>media/FrameRGrayMR.gif" style="background-repeat: repeat-y; background-position: left center;"></td>
	</tr>
	<tr>
		<td><img src="<%= SkinPath %>media/FrameRGrayBL.gif"></td>
		<td background="<%= SkinPath %>media/FrameRGrayBC.gif" style="background-repeat: repeat-x; background-position: center top;"></td>
		<td><img src="<%= SkinPath %>media/FrameRGrayBR.gif"></td>
	</tr>
</table>
