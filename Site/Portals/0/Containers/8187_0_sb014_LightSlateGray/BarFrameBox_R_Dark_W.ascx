...
<table width="100%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><img src="<%= SkinPath %>media/BarFrameRDarkTL.gif"></td>
		<td id="Td_Title_b014v20" background="<%= SkinPath %>media/BarFrameRDarkTC.gif" style="background-repeat: repeat-x; background-position: center bottom;">
		...
		<td><img src="<%= SkinPath %>media/BarFrameRDarkTR.gif"></td>
	</tr>
	<tr>
		<td background="<%= SkinPath %>media/FrameBoxRDarkWML.gif" style="background-repeat: repeat-y; background-position: right center;"></td>
		...
		<td background="<%= SkinPath %>media/FrameBoxRDarkWMR.gif" style="background-repeat: repeat-y; background-position: left center;"></td>
	</tr>
	<tr>
		<td><img src="<%= SkinPath %>media/FrameBoxRDarkWBL.gif"></td>
		<td background="<%= SkinPath %>media/FrameBoxRDarkWBC.gif" style="background-repeat: repeat-x; background-position: center top;"></td>
		<td><img src="<%= SkinPath %>media/FrameBoxRDarkWBR.gif"></td>
	</tr>
</table>
