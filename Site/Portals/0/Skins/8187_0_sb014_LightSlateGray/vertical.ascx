...
<table id="TableBg" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td rowspan="2" id="TdBgLeft">
		<img src="<%= SkinPath %>media/spacer.gif"></td>
		<td id="TdSkin"><img src="<%= SkinPath %>media/spacer780x1.gif"></td>
		<td rowspan="2" id="TdBgRight">
		<img src="<%= SkinPath %>media/spacer.gif"></td>
	</tr>
	<tr>
		<td id="TdMain">
		<table id="TableMain" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" align="center" width="100%" height="100%">
					<tr>
						<td valign="middle" nowrap>&nbsp;&nbsp;<dnn:CURRENTDATE runat="server" id="dnnCURRENTDATE" CssClass="dnnCURRENTDATE" DateFormat="MMMM d, yyyy" />&nbsp;
						</td>
			...
			<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
					<tr>
						...
						<table id="TableLeft" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
									...
									<tr>
										<td width="10" valign="bottom" bgcolor="#FFFFFF"><img src="<%= SkinPath %>media/spacer10x1.gif"></td>
										...
										<table border="0" cellspacing="0" cellpadding="0" width="100%">
											<tr>
												...
												<dnn:SOLPARTMENU runat="server" id="dnnSOLPARTMENU" cleardefaults="true" delaysubmenuload="true" display="vertical" usearrows="false" menueffectsmouseoverdisplay="None" menueffectsmouseouthidedelay="500" userootbreadcrumbarrow="false" useskinpatharrowimages="true" separator="&lt;img src=&quot;media/spacer.gif&quot;&gt;" downarrow="media/menuarrow_down.gif" rightarrow="media/menuarrow_right.gif" rootmenuitemlefthtml="&nbsp;" rootmenuitemrighthtml="&nbsp;" menucontainercssclass="MainMenu_MenuContainer_Vert" menubarcssclass="MainMenu_MenuBar_Vert" menubreakcssclass="MainMenu_MenuBreak_Vert" rootmenuitemcssclass="MainMenu_RootMenuItem_Vert" rootmenuitemactivecssclass="MainMenu_RootMenuItemActive_Vert" rootmenuitemselectedcssclass="MainMenu_RootMenuItemSel_Vert" rootmenuitembreadcrumbcssclass="MainMenu_RootMenuItemActive_Vert" submenuitemselectedcssclass="MainMenu_SubMenuItemSel" />
												</td>
											</tr>
										</table>
										</td>
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
											<tr>
												<td id="LeftPane" class="leftpane" runat="server" valign="top" height="100%" style="font-size: 1px;">&nbsp;
												</td>
											</tr>
											<tr>
												<td id="LeftPane2" class="leftpane2" runat="server" valign="bottom" style="font-size: 1px;">
												</td>
											</tr>
										</table>
										</td>
										<td width="11" valign="top" background="<%= SkinPath %>media/PanelMR.gif" style="background-repeat: repeat-y;"><img src="<%= SkinPath %>media/PanelMR.gif"></td>
									</tr>
								</table>
								</td>
							</tr>
						...
						<td valign="top" bgcolor="ffffff" background="<%= SkinPath %>media/sprtr.gif" style="background-repeat: repeat-x;">
					...
					<tr>
						...
						<table id="TableLeft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="10" background="<%= SkinPath %>media/BL.gif" style="background-repeat: no-repeat;"><img src="<%= SkinPath %>media/spacer10x1.gif"></td>
								<td width="11" valign="top" background="<%= SkinPath %>media/PanelML.gif" style="background-repeat: repeat-y; background-position: right top;"><img src="<%= SkinPath %>media/PanelML.gif"></td>
								<td height="10"><img src="<%= SkinPath %>media/spacer.gif"></td>
								<td width="11" valign="top" background="<%= SkinPath %>media/PanelMR.gif" style="background-repeat: repeat-y;"></td>
							</tr>
							<tr>
								...
								<td id="TdCTPH" width="100%" height="100%" background="<%= SkinPath %>media/PanelBC.gif" style="background-repeat: repeat-x; background-position: center top;"><img src="<%= SkinPath %>media/spacer.gif"></td>
