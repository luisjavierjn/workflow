  ...
  <table border="0" cellpadding="0" cellspacing="0" width="80%" align="left">
    ...
    <tr><td height="20%"></td><td></td></tr>
   	<tr>
		...
		<td>
			<font face="Arial" size="2">Un documento de <xsl:value-of select='param0'/>, N° <xsl:value-of select='param1'/> de fecha <xsl:value-of select='param2'/>, <xsl:value-of select='param3'/></font>
	...
	<tr>
		...
		<td>
			<font face="Arial" size="2">Ingrese al Sistema SPIN para revisar dicho documento</font>
		</td>
    </tr>
    <tr><td height="20%"></td><td></td></tr>
    <tr>
